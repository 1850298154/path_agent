...
def read_pickle(agent_list):
    # 打包存储UAV对象列表
    import pickle
    # filename = path_dir + 'agent100/' + onlyfilename+".pkl"
    filename = path_dir + 'agent100/' +"agent_list_100.pkl"
    # create_file(filename)
...
def read_agent100(agent_list):
    # print(agent_list)
    # print(
    #     'agent props have been saved in : "002/agent100/agent_list[i].json"')
    print(
        # f'agent props have been saved in : "{test_plan}/agent100/agent_list[i].json"')
        f'agent props have been read in : "{path_dir}/agent100/agent_list[i].json"')
